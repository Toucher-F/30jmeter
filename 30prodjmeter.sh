...
ssh -o StrictHostKeyChecking=no root@10.137.48.143 "touch /storage/app1-top-${DIRNAME} && nohup top -u 1 -b > /storage/app1-top-${DIRNAME} &" &
...
ssh -o StrictHostKeyChecking=no root@10.137.48.143 "touch /storage/app1-io-${DIRNAME} && iostat 3 -x > /storage/app1-io-${DIRNAME} &" &
...
#APP1TOP=$(ssh -o StrictHostKeyChecking=no root@10.137.48.143 "ps -ef | grep "top" | grep -v "grep" | awk '{print \$2}'")
...
#ssh -o StrictHostKeyChecking=no root@10.137.48.143 "kill -9 ${APP1TOP}"
...
APP1TOP=$(ssh -o StrictHostKeyChecking=no root@10.137.48.143 "ps -ef | grep "top" | grep -v "grep" | awk '{print \$2}' | xargs kill -9")
...
APP1TOP=$(ssh -o StrictHostKeyChecking=no root@10.137.48.143 "ps -ef | grep "iostat" | grep -v "grep" | awk '{print \$2}' | xargs kill -9")
...
scp -r root@10.137.48.143:/storage/app1-top-${DIRNAME} /30jmeter/${DIRNAME}/
scp -r root@10.137.144.173:/storage/app2-top-${DIRNAME} /30jmeter/${DIRNAME}/
scp -r root@10.137.48.137:/storage/pg-top-${DIRNAME} /30jmeter/${DIRNAME}/

scp -r root@10.137.48.143:/storage/app1-io-${DIRNAME} /30jmeter/${DIRNAME}/
scp -r root@10.137.144.173:/storage/app2-io-${DIRNAME} /30jmeter/${DIRNAME}/
scp -r root@10.137.48.137:/storage/pg-io-${DIRNAME} /30jmeter/${DIRNAME}/

ssh -o StrictHostKeyChecking=no root@10.137.48.143 "rm /storage/app1-top-${DIRNAME}"
...
ssh -o StrictHostKeyChecking=no root@10.137.48.143 "rm /storage/app1-io-${DIRNAME}"
